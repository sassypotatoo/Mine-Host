...
def build_context_block(state: dict) -> str:
    ...
    lines = [
        ...
        "",
        "STRICT MODE (skills/plugins): If any suitable Skill/Plugin exists for the action you're about to take, invoke it first.",
        "Prefer superpowers:subagent-driven-development for implementations and superpowers:systematic-debugging for debugging.",
        "Only fall back to direct Bash/Read/Edit/Write when no Skill applies; then explain why briefly.",
        "About MCP: use MCP integrations only when there is an applicable MCP tool/skill already configured; otherwise do not attempt to add one mid-task.",
        "STRICT MODE (skills/plugins/MCP): If any suitable Skill/Plugin/MCP tool exists for the action you're about to take, invoke/use it first.",
        "Prefer superpowers:subagent-driven-development for implementations and superpowers:systematic-debugging for debugging.",
        "Only fall back to direct Bash/Read/Edit/Write when no Skill/MCP applies; then explain why briefly.",
        "About MCP: use MCP integrations only when there's an applicable MCP tool/skill already configured; otherwise do not attempt to add one mid-task.",
